    ...
    <div className="fixed bottom-6 right-4 sm:right-6 z-[200] flex flex-col items-end gap-3">
      ...
      >
        ...
        <motion.a
          ...
          whileTap={{ scale: 0.93 }}
          className="w-13 h-13 sm:w-14 sm:h-14 rounded-full bg-[#25D366] shadow-lg flex items-center justify-center"
        ...
        >
          ...
          {/* Pulse ring */}
          <span className="absolute w-full h-full rounded-full bg-[#25D366] animate-ping opacity-25 pointer-events-none" />
        </motion.a>
      </div>
